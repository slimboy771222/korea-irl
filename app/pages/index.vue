...
const heroSlides = [
  { label: 'Seoul Spring', path: 'hero/seoul.webp' },
  { label: 'Busan Summer', path: 'hero/busan.webp' },
  { label: 'Jeju Autumn', path: 'hero/jeju.webp' },
  { label: 'Gyeongju Winter', path: 'hero/gyeongju.webp' },
